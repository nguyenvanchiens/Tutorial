...
const SECTIONS = [
  ...
  { id: 'backend', icon: '\u2699', label: '.NET Backend', children: [
    { id: 'be-cb', label: 'Cơ Bản', children: [
      { id: 'be-roadmap', label: 'Roadmap 20/80', src: '/BE/index.html' },
      { id: 'be-roadmap-detail', label: 'Lộ Trình A-Z', src: '/BE/roadmap-detail.html' },
      { id: 'be-path', label: 'Backend Path', src: '/BE/backend-path.html' },
      { id: 'be-csharp', label: 'C# Fundamentals', src: '/BE/csharp-basics.html' },
      { id: 'be-oop', label: 'OOP trong C#', src: '/BE/oop.html' },
      { id: 'be-linq', label: 'LINQ', src: '/BE/linq.html' },
      { id: 'be-sql', label: 'SQL Nền Tảng', src: '/BE/sql-basics.html' },
      { id: 'be-webapi', label: 'Web API Đầu Tiên', src: '/BE/webapi-first.html' },
      { id: 'be-efcore', label: 'EF Core', src: '/BE/efcore.html' },
      { id: 'be-di', label: 'Dependency Injection', src: '/BE/di.html' },
    ]},
    { id: 'be-nc', label: 'Nâng Cao', children: [
      { id: 'be-async', label: 'Async / Await', src: '/BE/async.html' },
      { id: 'be-rest', label: 'REST API Design', src: '/BE/rest-design.html' },
      { id: 'be-auth', label: 'Auth & JWT', src: '/BE/auth-jwt.html' },
      { id: 'be-caching', label: 'Caching', src: '/BE/caching.html' },
      { id: 'be-logging', label: 'Logging & Observability', src: '/BE/logging.html' },
      { id: 'be-errors', label: 'Error Handling & Resilience', src: '/BE/error-handling.html' },
      { id: 'be-clean', label: 'Clean Architecture', src: '/BE/clean-architecture.html' },
      { id: 'be-patterns', label: 'SOLID & Design Patterns', src: '/BE/design-patterns.html' },
    ...
    { id: 'be-ms', label: 'Master', children: [
      { id: 'be-cqrs', label: 'CQRS + MediatR', src: '/BE/cqrs.html' },
      { id: 'be-ddd', label: 'Domain-Driven Design', src: '/BE/ddd.html' },
      { id: 'be-messaging', label: 'Message Queue & Event-Driven', src: '/BE/messaging.html' },
      { id: 'be-sysdesign', label: 'System Design', src: '/BE/system-design.html' },
      { id: 'be-security', label: 'Security Deep-Dive', src: '/BE/security.html' },
      { id: 'be-advice', label: 'Loi Khuyen', src: '/BE/advice.html' },
    ]},
    { id: 'be-on', label: 'Ôn Tập', children: [
  ...
  { id: 'redis', icon: '\uD83D\uDD34', label: 'Redis', children: [
    { id: 'redis-cb', label: 'Cơ Bản', children: [
      { id: 'redis-roadmap', label: 'Roadmap',          src: '/REDIS/index.html' },
      { id: 'redis-install', label: 'Cài Đặt & CLI',    src: '/REDIS/install.html' },
      { id: 'redis-basics',  label: 'Cơ Bản',           src: '/REDIS/basics.html' },
    ]},
    { id: 'redis-nc', label: 'Nâng Cao', children: [
      { id: 'redis-patterns',   label: 'Patterns',       src: '/REDIS/patterns.html' },
      { id: 'redis-lua',        label: 'Lua Scripting',  src: '/REDIS/lua.html' },
      { id: 'redis-production', label: 'Production',     src: '/REDIS/production.html' },
    ]},
    { id: 'redis-ms', label: 'Master', children: [
      { id: 'redis-internals', label: 'Internals & Consistency', src: '/REDIS/internals.html' },
    ]},
    { id: 'redis-on', label: 'Ôn Tập', children: [
      { id: 'redis-interview', label: 'Phỏng Vấn', src: '/REDIS/interview.html' },
    ]},
  ]},
  { id: 'microservice', icon: '🕸', label: 'Microservices', children: [
    { id: 'micro-cb', label: 'Cơ Bản', children: [
      { id: 'micro-roadmap',  label: 'Roadmap',          src: '/MICROSERVICE/index.html' },
      { id: 'micro-monolith', label: 'Modular Monolith', src: '/MICROSERVICE/modular-monolith.html' },
      { id: 'micro-basics',   label: 'Cơ Bản',           src: '/MICROSERVICE/basics.html' },
      { id: 'micro-ddd',      label: 'DDD Tactical',     src: '/MICROSERVICE/ddd-tactical.html' },
    ]},
    { id: 'micro-nc', label: 'Nâng Cao', children: [
      ...
      { id: 'micro-testing',       label: 'Testing Phân Tán', src: '/MICROSERVICE/testing.html' },
      { id: 'micro-production',    label: 'Production', src: '/MICROSERVICE/production.html' },
    ]},
    { id: 'micro-ms', label: 'Master', children: [
      { id: 'micro-architect', label: 'Architect-Level', src: '/MICROSERVICE/architect.html' },
    ]},
    { id: 'micro-on', label: 'Ôn Tập', children: [
      { id: 'micro-interview', label: 'Phỏng Vấn', src: '/MICROSERVICE/interview.html' },
    ]},
  ]},
  { id: 'build', icon: '\uD83D\uDE80', label: 'Build & Deploy', children: [
    { id: 'build-cb', label: 'Cơ Bản', children: [
      { id: 'build-overview',   label: 'Tổng Quan',      src: '/BUILD/index.html' },
      { id: 'build-linux',      label: 'Linux & CLI',    src: '/BUILD/linux-cli.html' },
      { id: 'build-networking', label: 'Networking',     src: '/BUILD/networking.html' },
      { id: 'build-git',        label: 'Git & Workflow', src: '/BUILD/git.html' },
      { id: 'build-domain',     label: 'Domain & DNS',   src: '/BUILD/domain.html' },
      { id: 'build-secrets',    label: 'Config & Secrets', src: '/BUILD/secrets.html' },
    ]},
    { id: 'build-nc', label: 'Nâng Cao', children: [
    ...
    { id: 'build-ms', label: 'Master', children: [
      { id: 'build-k8s',      label: 'Kubernetes',       src: '/BUILD/kubernetes.html' },
      { id: 'build-iac',      label: 'Infrastructure as Code', src: '/BUILD/iac.html' },
      { id: 'build-sre',      label: 'SRE & Reliability', src: '/BUILD/sre.html' },
      { id: 'build-devsecops',label: 'DevSecOps',        src: '/BUILD/devsecops.html' },
  ...
  { id: 'ai', icon: '\uD83E\uDD16', label: 'Hoc AI', children: [
    { id: 'ai-basic', label: 'AI Cơ Bản', children: [
    ...
    { id: 'ai-advanced', label: 'AI Nâng Cao', children: [
      ...
      { id: 'ai-testing',     label: 'Testing với AI',             src: '/AI/testing-ai.html' },
      { id: 'ai-security',    label: 'Security Review Code AI',    src: '/AI/security-ai.html' },
    ]},
    { id: 'ai-expert', label: 'AI Cực Cao', children: [
